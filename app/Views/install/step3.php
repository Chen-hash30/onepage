    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-2xl w-full glass p-8 rounded-2xl glow-card transition-all duration-300">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold gradient-text mb-2">👤 设置管理员账户</h1>
                <p class="text-gray-400">创建系统管理员账户</p>
            </div>
                ...
                <?php for($i = 1; $i <= 5; $i++): ?>
                    <div class="flex-1 text-center relative">
                        <div class="w-10 h-10 rounded-full mx-auto mb-2 flex items-center justify-center font-semibold transition-all duration-300
                            <?= $i === 3 ? 'bg-purple-600 text-white' : ($i < 3 ? 'bg-green-600 text-white' : 'bg-gray-800 text-gray-500') ?>">
                            <?= $i < 3 ? '✓' : $i ?>
                        </div>
            ...
            <div class="px-4">
                ...
                <form method="POST" class="space-y-5">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">用于登录的用户名</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="admin_email" required
                            class="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all duration-200">
                        <p class="text-xs text-gray-500 mt-1">用于接收通知和找回密码</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="admin_password" required minlength="6"
                            class="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all duration-200">
                        <p class="text-xs text-gray-500 mt-1">至少 6 位字符</p>
                    </div>
                    
                    <div class="flex gap-4 pt-6">
                        <a href="?step=2" class="flex-1 px-6 py-3 bg-gray-800 text-gray-300 rounded-lg hover:bg-gray-700 transition-all duration-200 text-center font-medium">
                            ← 上一步
                        </a>
